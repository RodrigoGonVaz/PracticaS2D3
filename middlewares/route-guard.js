...
const usuarioLoggeado = (req,res,next) =>{
    ...
    //Si esta logeado enviarlo a la siguiente funcion (CONTROLLER)
    next()

}

//AREAS DE AUTENTICACION - EL USUARIO YA SE AUTENTICO Y QUIERE ENTRAR A LAS AREAS DE SIGNUP Y LOGIN. POR LO TANTO LO REDIRIGIMOSAL HOME
